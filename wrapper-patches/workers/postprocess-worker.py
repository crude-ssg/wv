...
class PostprocessWorker:
    ...
    async def get_base64_data(self, local_path: str) -> Optional[str]:
        ...
        try:
            ...
            async with aiofiles.open(local_path, 'rb') as file:
                ...
                mime_prefix = mime_map.get(Path(local_path).suffix, "data:application/octet-stream;base64,")
                return mime_prefix + data
        except Exception as e:
